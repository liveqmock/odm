	...
	<div>
		...
		<table cellpadding="0" cellspacing="0" width="100%" align="center"
			...
			<tr>
				...
				<td width="140" class="td2"><input type="text" name="kehu_id" id="kehu_id"/>
				</td>
				<td width="132" align="center" class="td1">联系人</td>
				<td width="140" class=""><input type="text" name="lianxiren" id="lianxiren"/></td>
