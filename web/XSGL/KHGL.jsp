...
$(document).ready(function(){
	  tabpanel = new TabPanel({
		...
		items : [{
			...
			html:'<iframe id="callIframe" src="DisPatch_getLevel23Url?m2=6&m3=0" width="50%" height="50%" frameborder="0"></iframe>',
			closable: false
		},{
			id:'toolbarPlugin2',
			title:'收货地址',
			icon:'image/read-n.gif',
			html:'<iframe id="callIframe" src="DisPatch_getLevel23Url?m2=6&m3=1" width="50%" height="50%" frameborder="0"></iframe>',
			closable: false
		}]
	});
});
