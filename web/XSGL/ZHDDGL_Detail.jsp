...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function docommit()
        {
            ...
            var zmishu = document.getElementById("zmishu").value;
            if(zmishu == 0)
            {
                alert("订单中未添加货号！");
                return;
...
<table cellpadding="0" cellspacing="0" width="100%"
    ...
    <tr>
        ...
        <td width="100" colspan="1" class="td2"><input type="button" onclick="docommit()"  value="修改订单确认"/>
            <input type="button" onclick="docommit()"  value="返回"/></td>
    </tr>
</table>
    ...
    function button(com, grid) {
        if (com == '删除') {
            ...
            if ($(".trSelected").length == 1) {
                ...
                JqueryDialog.Open('修改米数', 'DisPatch_getAddJsp?a=5&b=3&id='+id+"&mishu="+mishu,
                        230, 60);
