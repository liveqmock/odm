...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function backMenu() {
            var f = document.createElement("form");
            f.action = "DisPatch_getUrl?i=4&j=2";
            f.method = "post";
            document.body.appendChild(f);
            f.submit();
        }
    ...
    <%
        ...
        if(null != request.getSession().getAttribute
                ("orderDetail"))
        {
            tmp = (KHGL)request.getSession().getAttribute
                    ("orderDetail");
        }
        String yudingjin = "";
        String yewuyuan = "";
...
<table cellpadding="0" cellspacing="0" width="100%"
    ...
    <tr>
        ...
        <td width="100" colspan="1" class="td2"></td>
    </tr>
    <tr>
        ...
        <td width="140" colspan="4" class="td2"><%=tmp.getAddress()%></td>
...
<div>
    <table cellpadding="0" cellspacing="0" width="100%"
        ...
        <tr>
            ...
            <td width="140" class="td2">
                <input type="text" size="24" id="huohao" value=""
                       name="huohao"  maxlength="24"/>
            </td>
            ...
            <td width="100" colspan="1" class="td2"><input type="button" onclick="backMenu()"  value="返回订单管理"/></td>
