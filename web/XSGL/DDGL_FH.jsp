...
<body>
	<div>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%"
			id="tabs">
			<tr>
				<td class="tabs" align="center"><font color="white">发货订单管理</font>
				</td>
				<td class="tabs"></td>
			</tr>
		</table>
	...
	<div>
		...
		<table cellpadding="0" cellspacing="0" width="100%" align="center"
			...
			<tr>
             ...
             <input type="hidden" id="order_state" name="order_state" value="已申请发货" />
		</table>
	...
	function button(com, grid) {
		if (com == '删除') {
			...
			if ($(".trSelected").length == 1) {
                ...
                window.location.href = "DisPatch_getAddJsp?a=9&b=2"
                        + "&ddid="
