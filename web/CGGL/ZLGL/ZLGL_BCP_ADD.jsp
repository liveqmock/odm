...
<%
	...
	if(null != request.getAttribute("zlgl_bcp"))
	{
        ...
        if(xh.getZhenshu() != null)
        {
            zhenshu = xh.getZhenshu() ;
        }
	}
%>
	<form id="form1" name="form1" method="post"
		action="CGGL_dolist?hidden=add&type=ZLGL_BCP">
		<input type="hidden" name="id" value="<%=id%>"></input>
		<div>
			<table border="0" cellpadding="0" cellspacing="0" width="100%"
				id="tabs">
				<tr>
					<td class="tabs" align="center"><font color="white">添加半成品资料信息</font>
					</td>
					<td class="tabs"></td>
				</tr>
			</table>
						...
						<td>
							...
							<col style="width: 20%" />
								...
								<tr>
                                   ...
                                   <tr>
                                       <td class=td3 align="center" style="width:10%">卡号</td>
                                       <td><input type="text" size="24" id="kahao" value="<%=kahao%>"
                                                  name="kahao" maxlength="24"></input>
                                       </td>
                                       <td>&nbsp;</td>
                                   </tr>
                                   <tr>
                                       <td class=td3 align="center" style="width:10%">针数</td>
                                       <td><input type="text" size="24" id="zhenshu" value="<%=zhenshu%>"
                                                  name="zhenshu" maxlength="24"></input>
                                       </td>
                                       <td>&nbsp;</td>
                                   </tr>
