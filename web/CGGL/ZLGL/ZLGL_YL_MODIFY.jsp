...
<script type="text/javascript">
	...
	function backMenu() {
		...
		f.action = "DisPatch_getLevel23Url?m2=0&m3=0";
		//f.target = "mainframe";
		f.method = "post";
...
<%
	...
	String xilie = "";
	int id = -1;
	if(null != request.getAttribute("zlgl_yl"))
	{
		ZLGLYLZL xh = (ZLGLYLZL)request.getAttribute("zlgl_yl");
		if(null != xh.getXilie())
			xilie = xh.getXilie();
		...
		if(null != xh.getDanwei())
			danwei = xh.getDanwei();
		if(null != xh.getZhongliang())
			zhongliang = xh.getZhongliang();
...
%>
	<form id="form1" name="form1" method="post"
		action="CGGL_dolist?hidden=modify&type=ZLGL_YL">
		<input type="hidden" name="id" value="<%=id%>"></input>
		<div>
			<table border="0" cellpadding="0" cellspacing="0" width="100%"
				id="tabs">
				<tr>
					<td class="tabs" align="center"><font color="white">修改原料资料信息</font>
					</td>
					<td class="tabs"></td>
				</tr>
			</table>
					...
					<tr>
						<td>
							...
							<col style="width: 20%" />
								...
								<tr>
										<td class=td3 align="center" style="width:10%">原材料型号</td>
									...
									<tr>
										<td class=td3 align="center" style="width:10%">重量(克/m)</td>
										<td><input type="text" size="24" id="zhongliang" value="<%=zhongliang%>"
											name="zhongliang" maxlength="24"></input>
										</td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										<td class=td3 align="center" style="width:10%">成份</td>
	...
	<script>  
       <%
           String message = (String)request.getAttribute("modifyzlgl_ylerror");
			if (message != null && !"".equals(message)) {
				request.removeAttribute("modifyzlgl_ylerror");
		%>  
