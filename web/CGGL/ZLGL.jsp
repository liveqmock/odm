...
$(document).ready(function(){
	  tabpanel = new TabPanel({
		...
		items : [{
			...
			html:'<iframe id="callIframe" src="DisPatch_getLevel23Url?m2=0&m3=0" width="50%" height="50%" frameborder="0"></iframe>',
			closable: false
		},{
			id:'toolbarPlugin2',
			title:'半成品资料管理',
			icon:'image/read-n.gif',
			html:'<iframe id="callIframe" src="DisPatch_getLevel23Url?m2=0&m3=1" width="50%" height="50%" frameborder="0"></iframe>',
			closable: false
		},{
			id:'toolbarPlugin3',
			title:'成品资料管理',
			icon:'image/read-n.gif',
			html:'<iframe id="callIframe" src="DisPatch_getLevel23Url?m2=0&m3=2" width="50%" height="50%" frameborder="0"></iframe>',
			closable: false
		},{
			id:'toolbarPlugin4',
			title:'商品资料管理',
			icon:'image/read-n.gif',
			html:'<iframe id="callIframe" src="DisPatch_getLevel23Url?m2=0&m3=3" width="50%" height="50%" frameborder="0"></iframe>',
			closable: false
		}]
	});
});
