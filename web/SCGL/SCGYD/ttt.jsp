						...
						<td>
							...
							<col style="width: 20%" />
								...
								<tr>
										...
										<td>
                                            <select  class="flexselect"  id="jgxinghao"
                                                     name="jgxinghao" >
                                                <%
                                                     List<String>  strs = new ArrayList<String>();
                                                    if (null != session.getAttribute("typenums")) {
                                                        strs = (List<String>) session.getAttribute("typenums");
                                                    }
                                                    for(int i=0;i<strs.size();i++)
                                                    {
                                                %>
                                                <option <%if(strs.get(i).equals(jgxinghao)) {%> selected<%}%> ><%=strs.get(i) %></option>
                                                <%
                                                    }
                                                %>
                                            </select>
										...
										<td>
                                            <select  class="flexselect"  id="xinghao"
                                                ...
                                                <%
                                                    ...
                                                    {
                                                %>
                                                <option <%if(strs.get(i).equals(xinghao)) {%> selected<%}%> ><%=strs.get(i) %></option>
                                                <%
                                                    }
                                                %>
                                            </select>
									...
									<tr>
										...
										<td><input type="text" size="24" id="dbmingchen" value="<%=dbmingchen%>"
											name="dbmingchen" maxlength="24"></input>
										</td>
										<td>&nbsp;</td>
									</tr>
									<tr>
								 ...
								 <input type="text" size="24" id="chejian" value="<%=chejiansession%>"
										 onfocus="this.blur()" readonly="readonly"  style="color:gray" 
											name="chejian" maxlength="24"></input>
										</td>
										<td>&nbsp;</td>
								</tr>
								<tr>
