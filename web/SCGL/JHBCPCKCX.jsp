...
<body>
	<div>
		<table border="0" cellpadding="0" cellspacing="0" width="100%"
			id="tabs">
			<tr>
				<td class="tabs" align="center"><font color="white">半成品仓库查询</font>
				</td>
				<td class="tabs"></td>
			</tr>
		</table>
	...
	<div>
		...
		<table cellpadding="0" cellspacing="0" width="100%" align="center"
			...
			<tr>
				...
				<input type="hidden" name=ckname id=ckname ></input>
				<input type="hidden" name=mudidanhao id=mudidanhao ></input>
				...
				<td width="140" class=""><select name="bptype"
					id="bptype" class="a2" style="position: relative">
						<option value="半成品"  selected="selected" >半成品</option>
				</select></td>
				</tr>
				<tr>
			
				<td width="132" align="center" class="td1">条形码</td>
				<td width="140" class="td2"><input type="text" name="bupi_id" id=bupi_id></input>
				</td>
...
function gridFlash(){  
	...
	$("#flex1").flexigrid({
		...
		url : 'CGGL_dolist?hidden=manage&type=CKCX&bptype=bcp',
		dataType : 'json',
		colModel : [ {
			display : 'id',
			name : 'id',
	...
	function button(com, grid) {
       ...
       if (com == '开剪') {
			...
			if ($(".trSelected").length == 1) {
				window.location.href = "DisPatch_getAddJsp?a=2&b=4&id="
