...
<div>
		<table border="0" cellpadding="0" cellspacing="0" width="100%"
			id="tabs">
			<tr>
				<td class="tabs" align="center"><font color="white">单位管理</font>
				</td>
				<td class="tabs"></td>
			</tr>
		</table>
...
function gridFlash(){  
	...
	function button(com, grid) {
		...
		if (com == '删除') {
			...
			hidden.value = "add";
			location.href = "DisPatch_getAddJsp?a=2&b=3";
		} else if (com == '修改') {
			hidden.value="modify";  
	          if($(".trSelected").length==1){   
	        	  window.location.href =  "SCGL_dolist?hidden=premodify&type=WJGDWGL&id="+$('.trSelected', grid).find("td").eq(0).text();
