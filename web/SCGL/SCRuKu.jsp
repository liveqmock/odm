...
<div>
	<table border="0" cellpadding="0" cellspacing="0" width="820px"
				id="tabs">
				<tr >
					<td class="tabs"  align="center" ><font color="white" >生产入库管理</font>
						</td>
					<td class="tabs"></td>
				</tr>
			</table>
...
<div style="height: 6px">
	...
	<div>
		<table cellpadding="0" cellspacing="0" width="820px" align="center"
			...
			<tr>
				...
				<td width="140" class="td2"><input type="text" id="bupi_id" name="bupi_id"/>
				</td>
			...
			<tr>
				<td width="132" align="center" class="td1">生产单号</td>
				<td width="140" class="td2"><input type="text" id="gongyidan_id"  name="gongyidan_id"/>
				</td>
	...
	<div>
		<table id="flex1" width="820px" style="display: none; font-size: 12px;"
			style="top:7px"></table>
...
function gridFlash(){  
	$("#flex1").flexOptions({params: [
	                                  {name:'gongyidan_id', value:$("#gongyidan_id").val()},
	...
	$("#flex1").flexigrid({
		url : 'SCGL_dolist?hidden=manage&type=SCRuKu',
		dataType : 'json',
		colModel : [ {
			display : 'id',
			name : 'id',
		...
		if (com == '删除') {
			...
			if ($('.trSelected', grid).length == 0) {
				...
				if (confirm('是否删除这 ' + $('.trSelected', grid).length + ' 条记录吗?')) {
					...
					var url = "SCGL_dolist?hidden=delete&type=SCRuKu&" + id;
					del(url);
				}
			}
		} else if (com == '添加') {
