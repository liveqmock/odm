...
<script> 
	...
	function tongguo()
	{
		...
		f.action = "SCGL_dolist?hidden=modify&type=ZHIJIAN_SCZJG&bptiaoma="+ui1.value
  ...
  function add()
  {
		...
		if(ui1.value == "" || ui1.value == "0")
		{
 		...
 		location.href = "CKGL_dolist?hidden=add&type=SCRKSQ&mishu="+ui1.value+
...
<%
	...
	if(null  != session.getAttribute("scdid"))
	{
		cgdid = (String)session.getAttribute("scdid");
	}
...
<body>
	<div>
		<table border="0" cellpadding="0" cellspacing="0" width="100%"
			id="tabs">
			<tr>
				<td class="tabs" align="center"><font color="white">生产质检详细</font>
				</td>
				<td class="tabs"></td>
			</tr>
		</table>
	...
	<div>
		<table cellpadding="0" cellspacing="0" width="100%" align="center"
			...
			<tr>
				...
				<td width="132" align="center" class="td1">自加工单号:</td>
...
function gridFlash(){  
	...
	$("#flex1").flexigrid({
		...
		url : 'CKGL_dolist?hidden=manage&type=SCZJGRKZJ',
		dataType : 'json',
		colModel : [ {
			display : 'id',
			name : 'id',
