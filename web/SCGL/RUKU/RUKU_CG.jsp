...
<%
	...
	if(zijianid.equals(""))
	{
		...
		else
		{
		      ...
		      zijianid =  "RK"+formater.format(new Date())+String.format("%04d", intRd);
...
<body>
	<div>
		<table border="0" cellpadding="0" cellspacing="0" width="100%"
			id="tabs">
			<tr>
				<td class="tabs" align="center"><font color="white">采购单入库详细</font>
				</td>
				<td class="tabs"></td>
			</tr>
		</table>
	...
	<div>
		<table cellpadding="0" cellspacing="0" width="100%" align="center"
			...
			<tr>
				...
				<td width="140" class="">&nbsp;&nbsp;&nbsp;<input type="button" value="返回" /></td>
			</tr>
...
function gridFlash(){  
	...
	$("#flex1").flexigrid({
		...
		url : 'CKGL_dolist?hidden=manage&type=CGRK2',
		dataType : 'json',
		colModel : [ {
			display : 'id',
			name : 'id',
