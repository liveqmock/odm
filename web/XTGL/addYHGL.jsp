   ...
   function changBumen()
   {
	  ...
	  else
	  {
		  for(var i=0;i<array32[id].length;i++){ 
			  str += array32[id][i];
			  html += "<input type='checkbox' checked name='check"+i+"' id='check"+i+"' > <a onclick='selectcheckbox("+i+")' style='cursor:hand;color:black' >"+array32[id][i]+"</a></input>";
			  if(str.length > 20)
			  {
				  html += "<br></br>";
				  str = "";
...
%>
	<form id="form1" name="form1" method="post" action="XTGL_dolist?hidden=add&type=YHGL">
