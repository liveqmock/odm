...
<body>
	...
	<form id="form1" name="form1" method="post" action="XTGL_dolist?hidden=add&type=XTCS">
		<DIV id=UpdatePanel1>
			<TABLE align=center>
				<TBODY>
					<TR>
								...
								<TBODY>
									<TR>
										<TD style="HEIGHT: 26px" width=200 align=middle><INPUT
											...
											src="images/Sure1.gif" type=image></TD>	<TD style="HEIGHT: 26px" width=200 align=middle><INPUT
											style="POSITION: relative; BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px"
