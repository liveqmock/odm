...
public class cangKuChaXun   implements Serializable {
	...
	private Integer num;
	private Integer KJ_num;
	private Integer KY_num;
	...
	public Integer getKJ_num() {
		return KJ_num;
	}

	public void setKJ_num(Integer kJ_num) {
		KJ_num = kJ_num;
	}

	public Integer getKY_num() {
		return KY_num;
	}

	public void setKY_num(Integer kY_num) {
		KY_num = kY_num;
	}
	...
	public String getZhiliangdengji() {
		return zhiliangdengji;
	}

	public void setZhiliangdengji(String zhiliangdengji) {
		this.zhiliangdengji = zhiliangdengji;
	}
	...
	public void setPinji(String pinji) {
		this.pinji = pinji;
	}
	...
	public String getRukdan_id() {
		return rukdan_id;
	}

	public void setRukdan_id(String rukdan_id) {
		this.rukdan_id = rukdan_id;
	}
